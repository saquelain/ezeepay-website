    ...
    <main ref={containerRef} className="bg-[#F7F5FC] text-[#1D1D2B]">
      ...
      <div className="products-wrapper relative">
        {PRODUCTS.map((p) => (
          ...
          >
            {/* Scene (image side) */}
            <div className="scene absolute left-0 top-0 h-full w-full overflow-hidden lg:p-4">
            ...
            {/* Text column */}
            <div className="panel-text absolute right-0 top-0 hidden h-full w-1/2 items-center lg:flex">
