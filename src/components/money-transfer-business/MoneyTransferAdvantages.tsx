...
const ADVANTAGES: { icon: LucideIcon; title: string; desc: string }[] = [
  {
    ...
    desc: "Start transfers anytime, anywhere — 24x7 access from a single app, no bank queues or fixed hours.",
  },
  {
    icon: Zap,
    title: "Speed & Efficiency",
    desc: "Near-instant settlement powered by streamlined processing, cutting delays and manual errors.",
  },
  {
    icon: ShieldCheck,
    title: "Improved Security",
    desc: "End-to-end encryption, two-factor authentication, and biometric checks protect every transaction.",
  },
  {
    icon: Wallet,
    title: "Cost Savings",
    desc: "Transparent, low fees with no hidden charges — and a fully digital flow that cuts paperwork costs.",
  },
  {
    icon: LayoutGrid,
    title: "Additional Features",
    desc: "Bill payments, recharges, and more, bundled into the same app alongside money transfer.",
  },
  {
    icon: ThumbsUp,
    title: "Enhanced User Experience",
    desc: "Transaction history, instant alerts, and dedicated support for a smooth, dependable experience.",
  },
];

export default function MoneyTransferAdvantages() {
    ...
    >
      <div className="relative mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            Advantages of a{" "}
            <span className="text-brand-orange">DMT Business</span>
          </h2>
          <p
          ...
          >
            Everything that makes Ezeepay's money transfer service a
            dependable earning stream for your shop.
          </p>
        </div>
