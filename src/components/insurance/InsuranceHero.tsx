...
import { ArrowRight, ShieldCheck, HeartPulse, Car } from "lucide-react";
        ...
        <div className="mt-10 grid grid-cols-1 items-start gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-8">
          <div>
            ...
            <p className="mt-6 max-w-xl text-xl leading-relaxed text-brand-grey">
              Help your customers secure their life, health, and vehicles
              with Ezeepay's insurance services — and earn commission on
              every policy you sell.
            </p>

            <p className="mt-4 max-w-xl leading-relaxed text-brand-grey">
              Ezeepay allows retailers to offer life, health, and motor
              insurance products to customers in rural and semi-urban areas,
              right from their shop. Guide customers through policy
              selection, complete verification, and issue coverage in
              minutes — no branch visits, no paperwork hassle.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-2xl lg:max-w-none">
            <div className="relative h-[420px] w-full lg:h-[600px]">
              <Image
                src="/images/services/insurance/hero-image.png"
                alt="Ezeepay app — Insurance services including life, health, and motor insurance"
                fill
                priority
