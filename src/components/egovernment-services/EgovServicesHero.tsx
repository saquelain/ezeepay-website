...
const HIGHLIGHTS = [
  { icon: FileText, label: "GST & ITR Filing" },
  { icon: Landmark, label: "MSME & Identity Services" },
  { icon: Wallet, label: "Extra Side Income" },
];

export default function EgovServicesHero() {
  return (
        ...
        <div className="mt-10 grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-8">
          <div>
            ...
            <p className="mt-8 max-w-xl text-xl leading-relaxed text-brand-grey">
              Retailers can register GST, file ITR, and fill MSME forms for
              their customers' businesses with Ezeepay — and earn extra side
              income on every service.
            </p>

            <p className="mt-4 max-w-xl leading-relaxed text-brand-grey">
              Ezeepay allows retailers to provide different e-governance
              services to their customers living in rural areas, including
              PAN card making, ITR filing, GST registration, MSME
              registration, and other financial documents — without a trip to
              a government office.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-2xl lg:max-w-none">
            <div className="relative h-[420px] w-full lg:h-[600px]">
              <Image
                src="/images/services/egovernment-services/hero-image.png"
                alt="Ezeepay app — E-Governance services including GST, Identity, Tax and other services"
                fill
                priority
