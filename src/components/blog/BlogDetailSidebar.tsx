    ...
    <aside className="space-y-6">
      ...
      <div className="rounded-2xl border border-brand-purple/10 bg-white p-6 shadow-sm">
        ...
        <a
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-purple-dark text-white transition-colors hover:bg-brand-purple"
        >
      ...
      <div className="rounded-2xl border border-brand-purple/10 bg-brand-purple-light/40 p-6">
        ...
        <ul className="mb-5 space-y-2">
          {["Attractive Commissions", "24/7 Support", "Trusted by Millions"].map(
            (item) => (
              <li
                key={item}
                className="flex items-center gap-2 text-[13px] font-medium text-brand-purple-dark"
              >
        ...
        <Link
          href="/join/agent"
          className="block w-full rounded-xl bg-brand-purple-dark px-5 py-3 text-center text-[14px] font-semibold text-white shadow-sm transition-colors hover:bg-brand-purple"
        >
          Join as an Agent →
        </Link>
      </div>
