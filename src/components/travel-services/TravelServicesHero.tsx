...
import { ArrowRight, Plane, Train, Bus } from "lucide-react";
...
const HIGHLIGHTS = [
  ...
  { icon: Train, label: "Train Ticket Booking" },
  { icon: Bus, label: "Bus Ticket Booking" },
];

export default function TravelServicesHero() {
  return (
        ...
        <div className="mt-10 grid grid-cols-1 items-start gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-8">
          <div>
            ...
            <p className="mt-6 max-w-xl text-xl leading-relaxed text-brand-grey">
              Book flights, trains, and buses for your customers with
              Ezeepay's travel services — and earn commission on every
              booking you make.
            </p>

            <p className="mt-4 max-w-xl leading-relaxed text-brand-grey">
              Ezeepay allows retailers to offer travel booking services to
              customers in rural and semi-urban areas, right from their shop.
              Search, compare, and confirm tickets in a few clicks — no need
              for customers to visit a travel agent or booking counter.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-2xl lg:max-w-none">
            <div className="relative h-[420px] w-full lg:h-[600px]">
              <Image
                src="/images/services/travel-services/hero-image.png"
                alt="Ezeepay app — Travel services including flight, train, and bus ticket booking"
                fill
                priority
