...
const HIGHLIGHTS = [
  { icon: Landmark, label: "Open Bank Accounts" },
  { icon: ArrowLeftRight, label: "Send & Receive Money" },
  { icon: CreditCard, label: "Credit & Debit Cards" },
];

export default function NeoBankingHero() {
  return (
        ...
        <div className="mt-10 grid grid-cols-1 items-start gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-8">
          <div>
            ...
            <p className="mt-6 max-w-xl text-xl leading-relaxed text-brand-grey">
              Open bank accounts, receive/send money through, apply for
              credit/debit cards, and other neo-banking services with
              Ezeepay.
            </p>

            <p className="mt-4 max-w-xl leading-relaxed text-brand-grey">
              With Neo banking, be the bank for your customers. You can
              become its provider for every service that the bank provides,
              and this is not where it ends. Earn commissions on every
              transaction that happens via the platform. Interact with more
          ...
          <div className="relative mx-auto w-full max-w-2xl lg:max-w-none">
            <div className="relative h-[420px] w-full lg:h-[600px]">
              <Image
                src="/images/services/neo-banking/hero-image.png"
                alt="Ezeepay app — Neo banking services including account opening, money transfer, and card issuance"
                fill
                priority
