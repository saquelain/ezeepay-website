...
import { ArrowRight, Wallet, Fingerprint, MapPin } from "lucide-react";
...
const HIGHLIGHTS = [
  ...
  { icon: Fingerprint, label: "Aadhaar & Biometric Secure" },
  { icon: MapPin, label: "Works in Every Locality" },
];

export default function MicroAtmHero() {
  return (
        ...
        <div className="mt-10 grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.05fr_1fr] lg:gap-8">
          <div>
            ...
            <p className="mt-8 max-w-xl text-xl leading-relaxed text-brand-grey">
              Turn your shop into a cash withdrawal point with Ezeepay's
              Micro ATM. Aadhaar and biometric verified — no card, no
              internet banking required for your customers.
            </p>
          ...
          <div className="relative mx-auto w-full max-w-2xl lg:max-w-none">
            <div className="relative h-[420px] w-full lg:h-[600px]">
              <Image
                ...
                alt="Ezeepay app — Micro ATM cash withdrawal"
                fill
                priority
